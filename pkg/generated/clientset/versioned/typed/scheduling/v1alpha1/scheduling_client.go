...
type SchedulingV1alpha1Interface interface {
	...
	ClusterNodeResourcePoliciesGetter
	NodeResourcePoliciesGetter
}

// SchedulingV1alpha1Client is used to interact with features provided by the scheduling.crane.io group.
