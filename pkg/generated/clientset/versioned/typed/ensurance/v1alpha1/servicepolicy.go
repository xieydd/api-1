...
type ServicePoliciesGetter interface {
	ServicePolicies() ServicePolicyInterface
}
...
func newServicePolicies(c *EnsuranceV1alpha1Client) *servicePolicies {
...
func (c *servicePolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ServicePolicy, err error) {
	result = &v1alpha1.ServicePolicy{}
	err = c.client.Get().
...
func (c *servicePolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ServicePolicyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ServicePolicyList{}
	err = c.client.Get().
		Resource("servicepolicies").
...
func (c *servicePolicies) Create(ctx context.Context, servicePolicy *v1alpha1.ServicePolicy, opts v1.CreateOptions) (result *v1alpha1.ServicePolicy, err error) {
	result = &v1alpha1.ServicePolicy{}
	err = c.client.Post().
		Resource("servicepolicies").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *servicePolicies) Update(ctx context.Context, servicePolicy *v1alpha1.ServicePolicy, opts v1.UpdateOptions) (result *v1alpha1.ServicePolicy, err error) {
	result = &v1alpha1.ServicePolicy{}
	err = c.client.Put().
		Resource("servicepolicies").
...
func (c *servicePolicies) UpdateStatus(ctx context.Context, servicePolicy *v1alpha1.ServicePolicy, opts v1.UpdateOptions) (result *v1alpha1.ServicePolicy, err error) {
	result = &v1alpha1.ServicePolicy{}
	err = c.client.Put().
		Resource("servicepolicies").
		Name(servicePolicy.Name).
...
func (c *servicePolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ServicePolicy, err error) {
	result = &v1alpha1.ServicePolicy{}
